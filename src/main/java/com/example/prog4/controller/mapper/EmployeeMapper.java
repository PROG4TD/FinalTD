...
public class EmployeeMapper {
    ...
    public CnapsEmployee toCnapsEmployeeDomain(com.example.prog4.repository.entity.Employee employee){
    ...
    public com.example.prog4.repository.entity.Employee toCnapsEmployeeView(com.example.prog4.repository.entity.Employee employee, CnapsEmployee cnapsEmployee){
        com.example.prog4.repository.entity.Employee employee1 = employee;
